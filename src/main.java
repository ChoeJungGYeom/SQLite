...
//			String sql2 = "insert into g_artists (name, a_type, a_year, debut, regdate)" + " values ('방탄소년단','남성','2010년대','2014년',datetime('now','localtime'));";
...
//			String sql3 = "update g_artists set debut = '2013년' " + "where id=7 ;";
